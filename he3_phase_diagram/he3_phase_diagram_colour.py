...
h.DEFAULT_SC_CORRS = "WS15"
TAB_WS15 = h.t_AB(p_smooth)*h.Tc_mK(p_smooth)

h.DEFAULT_SC_CORRS = "Choi-interp"
TAB_Choi = h.t_AB(p_nodes)*h.Tc_mK(p_nodes)

h.DEFAULT_SC_CORRS = "Choi-poly"
TAB_ChoiPoly = h.t_AB(p_smooth)*h.Tc_mK(p_smooth)

h.DEFAULT_SC_CORRS = "Wiman-thesis"
TAB_WimThe = h.t_AB(p_smooth)*h.Tc_mK(p_smooth)
...
ax.plot(TAB_WS15, p_smooth, label=r"$T_{AB}$, WS 2015")
ax.plot(TAB_Choi, p_nodes, 'x', label=r"$T_{AB}$, Choi et al")
ax.plot(TAB_ChoiPoly, p_smooth, label=r"$T_{AB}$, Choi et al poly")
ax.plot(TAB_WimThe, p_smooth, label=r"$T_{AB}$, Wiman thesis")
