...
for m, p in enumerate(p_arr):
    ...
    for n, t in enumerate(t_arr[t_arr < 1]):
        ...
        Apg_conf_BB_list[m][n], sigma_bw_BB_arr[m,n], sigma_tot_BB_arr[m,n] = c.get_confine(t, p, w/2, "B", "B", 
                                                                                            bcs = [hw.bc_min_pb, hw.bc_neu], maxiter=50, f_tol=1e-3)
...
confine_sol_data_min_1100_BB = (Apg_conf_BB_list, sigma_bw_BB_arr, sigma_tot_BB_arr, T_arr, p_arr)
...
confine_sol_data_min_1100_AA = (Apg_conf_AA_list, sigma_bw_AA_arr, sigma_tot_AA_arr, T_arr, p_arr)


with open('confine_sol_data_min_1100_BB_29x25.pickle', 'wb') as f:
    pic.dump(confine_sol_data_min_1100_BB, f)
...
with open('confine_sol_data_min_1100_AA_29x25.pickle', 'wb') as f:
    pic.dump(confine_sol_data_min_1100_AA, f)
