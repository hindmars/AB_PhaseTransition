...
Cplot = plot1.contour(Temperature*1000, pressure, ThinWall_Estimate_Rc_DiffFABGLScaled, colors='black');plot1.clabel(Cplot, inline=True, fontsize=8.5, colors='r')
...
DensityPlot = plot1.pcolormesh(Temperature*1000, pressure, ThinWall_Estimate_Rc_DiffFABGLScaled);
...
cs = plot1.contourf(X*(10**3), Y, ThinWall_Estimate_Rc_DiffFABGLScaled, locator=ticker.LogLocator(), cmap=cm.PuBu_r, levels=LLLLL);plot1.ylabel(r'$p/bar$'); plot1.xlabel(r'$T$/mK');
