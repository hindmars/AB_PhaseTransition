...
def do_one_plot(ax, sc_type, p, ls_mk, lbls=None):
    ...
    beta_24 = (h.beta_norm(1, p, 2) + h.beta_norm(1, p, 4)) /h.beta_const
    beta_plot(ax, p, beta_24, ls_mk, 'k', sc_type)
...
ax.set_title(r'$\beta^{\rm sc}_{24}/\beta_0$')

fig.tight_layout()


if savefig:
    fig.savefig('beta_24_compare.pdf')
